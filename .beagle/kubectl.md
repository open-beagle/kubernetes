...
# 清理并编译
rm -rf _output && \
export KUBE_GIT_VERSION=v1.30.14-beagle && \
...
docker build \
  ...
  -t registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle-amd64 \
  --build-arg BASE=registry.cn-qingdao.aliyuncs.com/wod/debian-base:v1.3.0-amd64 \
  --build-arg VERSION=v1.30.14-beagle \
...
docker build \
  -f .beagle/kube-apiserver.dockerfile \
  -t registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle-arm64 \
...
# 推送镜像
docker push registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle-amd64
docker push registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle-arm64

# 创建并推送 multi-arch manifest
docker manifest create registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle \
  registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle-amd64 \
  registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle-arm64
docker manifest push registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle
```
...
# 将镜像改为: registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.30.14-beagle
...
1. **确认 kube-apiserver 版本**
   ...
   # Server Version 应该显示 v1.30.14-beagle
   ```
